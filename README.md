...
- **📱 Native Android app (Seeker / dApp Store)** — the live site is wrapped as a native Android app (Capacitor) and **submitted to the Solana dApp Store** (in review), backed by published [Privacy Policy](https://clucknorris.app/privacy) and [Terms of Use](https://clucknorris.app/terms). Because it loads the live site, every web ship reaches the app instantly — no resubmission. *Honest scope: deeper Mobile Wallet Adapter / Seed Vault integration is roadmap, not yet built.*
