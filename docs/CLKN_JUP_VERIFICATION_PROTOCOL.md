...
- **Liq/MC ratio: ≥10% of market cap in QUOTE-SIDE liquidity** is "generally considered healthy" at small-cap size (ROSE at ~$243k MC ⇒ ~$24k quote-side needed; it had ~$8k — the single biggest gap). Quote-side means the USDC/SOL half, not the token half. Budget this at intake: a client at $X MC needs ~$X/20 in quote capital deployed just for this line item, or a smaller MC story.
