...
export const TOOLS = [
  ...
  { id: "firepit",    route: "/tools/firepit",    title: "Firepit",         icon: "🔥", tier: "wallet", ready: false,
  ...
  { id: "burn",       route: "/tools/burn",       title: "Project Burn",    icon: "🕯", tier: "wallet", ready: false,
    blurb: "Burn project supply and get a verifiable receipt for it." },
  { id: "listing",    route: "/tools/listing",    title: "Listing Checkup", icon: "📋", tier: "free",   ready: false,
    blurb: "What a listing venue will check before it lists a token — run it on yours first." },
  { id: "bags",       route: "/tools/bags",       title: "Launches",        icon: "🎒", tier: "free",   ready: false,
    blurb: "Live launches and graduations, read straight off the chain." },
  { id: "alpha",      route: "/tools/alpha",      title: "Daily Brief",     icon: "📰", tier: "free",   ready: false,
    blurb: "The flock's read on Solana today: the mood, what's moving, where the fees are." },
  { id: "xray",       route: "/tools/xray",       title: "Wallet X-Ray",    icon: "🔎", tier: "pass",   ready: false,
    blurb: "Follow what a wallet actually did — funding, flows and counterparties." },
  { id: "holders",    route: "/tools/holders",    title: "Holders",         icon: "👥", tier: "pass",   ready: false,
    blurb: "Who holds a token, how concentrated it is, and how that changed." },
  { id: "trace",      route: "/tools/trace",      title: "Trace",           icon: "🧭", tier: "pass",   ready: false,
  ...
  { id: "hatchery",   route: "/tools/hatchery",   title: "Hatchery",        icon: "🥚", tier: "paid",   ready: false,
