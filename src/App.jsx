...
const LESSONS = [
...

  {
    ...
    questions: [
      ...
      { q: "On Solana, MEV is:", options: ["Impossible on Solana because of its parallel execution", "Very real — sandwich bots pay validators for ordering instead of watching a public mempool", "More severe than on Ethereum due to lower block times", "Only affects large traders moving over $100K per swap"], correct: 1, explanation: "Solana has no public mempool, so bots cannot watch pending trades the Ethereum way — but they pay validators for transaction ordering (Jito bundles), and sandwich attacks on Jupiter and Raydium routes are common, especially during launches. Speed does not remove MEV. Tight slippage is your defence." },
    ],
  },

  {
    ...
    questions: [
      ...
      { q: "What does a burn mechanism do?", options: ["Destroys the project permanently by removing all tokens", "Permanently removes tokens from circulation reducing supply", "Freezes trading temporarily during scheduled burn events", "Sends tokens to the dev wallet for redistribution later"], correct: 1, explanation: "Burning tokens reduces supply over time. If demand stays the same and supply decreases, price pressure is upward. A burn on a token nobody wants changes nothing — demand still has to be there." },
