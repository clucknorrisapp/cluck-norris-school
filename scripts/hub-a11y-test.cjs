...
const PAGES = [
  ...
  { path: "/solana/buying", name: "The Solana Room — what actually happens when you buy" },
  { path: "/solana/transfers", name: "The Solana Room — sending tokens, and why the first one costs extra" },
  { path: "/solana/fees", name: "The Solana Room — what a transaction actually costs" },
