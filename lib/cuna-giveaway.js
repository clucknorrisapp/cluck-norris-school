  ...
  while (s.cursorMs < ceiling && slices < MAX_SLICES_PER_RUN) {
    ...
    try {
      ...
      if (e && e.message === 'slice_timeout') {
        // Same treatment as a slice the tape itself couldn't fully cover: keep whatever was
        // already credited, do NOT advance the cursor past this slice, retry it next tick.
