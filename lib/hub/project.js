...
function approveProject(registry, project, { nowUnix, reserved, appliedAt } = {}) {
  const reg = registry || {};
...
module.exports = { TOKEN_PROGRAMS, UNSUPPORTED_EXTENSIONS, canonicalJson, sha256, validateProject, approveProject, validateTerms, createVersion, versionFor, verifyVersionHash, milestonesInit, setMilestoneOnce, validateBrand: brandLib.validateBrand };
