...
const RESERVED_PROJECT_IDS = new Set(["settle"]);
...
module.exports = { TOKEN_PROGRAMS, UNSUPPORTED_EXTENSIONS, RESERVED_PROJECT_IDS, canonicalJson, sha256, validateProject, approveProject, validateTerms, createVersion, versionFor, verifyVersionHash, milestonesInit, setMilestoneOnce, validatePayoutSources, withPayoutSources, validateBrand: brandLib.validateBrand };
