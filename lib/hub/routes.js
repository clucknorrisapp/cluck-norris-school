    ...
    try {
      ...
      if (b.sent) {
        ...
        const verdictOf = (r) => {
          ...
          // (Codex 2026-09-17, finding 3); a transfer older than the batch cannot be its payment.
          ...
          return payoutVerify.rowPaidBy(txBySig.get(sg), { mint, wallet: w, minRaw: (bt.amounts || {})[w], notBefore: bt.at });
        };
