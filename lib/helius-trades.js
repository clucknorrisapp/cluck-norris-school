...
async function getTokenBuyersInWindowHelius(mint, fromMs, toMs, {
  ...
  // 4. classify buys (pure, unit-tested — see classifyBuyersFromTxs).
  const buyers = classifyBuyersFromTxs(txs, mint, { solUsd, tokenPriceUsd });
  return { buyers, txsScanned: txs.length, source: "helius", reachedWindowStart };
}
...
module.exports = { getTokenBuyersInWindowHelius, getWalletTokenPositionHelius, getTradeTapeHelius, classifyBuyersFromTxs };
