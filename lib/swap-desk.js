...
// is the entire server-side change — but read the liquidity note first: ROSE's pool held ~$7K
// when added (2026-08-03) vs ~$22-31K for the others, and a shallow pool is a cheap-to-move
// price feed. The bands, the gap guard and the daily caps are what bound that risk; do not
// widen caps without remembering the thinnest token sets the desk's real exposure.
const TOKENS = {
  [CLKN_MINT]: "CLKN",
  [NORMIE_MINT]: "NORMIE",
  [ROSE_MINT]: "ROSE",
