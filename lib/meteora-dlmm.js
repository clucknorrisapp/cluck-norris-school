...
async function rebalanceQuote({ positionPubkey, strategy = "curve", topUpX = 0, topUpY = 0 } = {}) {
  ...
  return {
    ...
    withdrawX: toUi(sim.actualAmountXWithdrawn, decX), withdrawY: toUi(sim.actualAmountYWithdrawn, decY),
    depositX: toUi(sim.actualAmountXDeposited, decX), depositY: toUi(sim.actualAmountYDeposited, decY),
