...
// Mainnet RPC — the project's Helius key with a public fallback (same pattern as the
// Orca adapter + securitycoop.js, so a fresh cloud clone without the key still reads).
function rpcUrl() {
