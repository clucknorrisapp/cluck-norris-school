...
// The stream the pool is drawn from: what the vesting schedules release TODAY, across every lock
// that is past its cliff and not yet finished. Locks still inside their cliff release nothing yet,
// and finished ones release nothing any more — counting either would publish a pool the schedules
// cannot actually fund.
function dailyUnlockRaw(locks, nowUnix) {
...
module.exports = {
  DAY, normalizeEscrow, poolForDay, dailyUnlockRaw, disqualify, qualifies, weightOf, accrueDay,
