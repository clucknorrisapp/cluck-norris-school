...
function renderAssetPage(a, lang, langs) {
  ...
  <div class="hero">
    ...
    <div class="hero-row">
      <div class="coin-badge"><img src="/learn-icons/${esc(a.slug)}.png" alt="${esc(a.ticker)} logo" loading="lazy" onerror="this.replaceWith(document.createTextNode('${esc(a.ticker)}'))"></div>
...
function renderHub(assets, lang, langs) {
  ...
  const cards = assets.map((a) => `<a class="hub-card" href="${urlFor(lang, a.slug)}">
    <div class="b"><img src="/learn-icons/${esc(a.slug)}.png" alt="${esc(a.ticker)} logo" loading="lazy" onerror="this.replaceWith(document.createTextNode('${esc(a.ticker)}'))"></div>
