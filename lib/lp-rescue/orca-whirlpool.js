...
async function scanWalletOrca(ownerAddress) {
  ...
  for (const mint of nftMints) {
    ...
    diagnostics.push("Manage or withdraw at orca.so — Orca's own frontend supports this position (LP Rescue in-app withdrawal covers Meteora DLMM today)");
