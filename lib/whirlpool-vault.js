...
// The MM operator wallet's public key (or null). Used by the buy poller to skip the
// vault's own liquidity operations so they don't post as "community reinvestment" buys.
function operatorPubkey() { const o = operator(); return o ? o.publicKey.toBase58() : null; }
...
module.exports = { isEnabled, operatorPubkey, tick, tickAskWall, tickSol, rebalanceInventory, rebalancePools, manualSwap, status, costs, earnings, publicPositions, getConfig, setConfig, listModes, previewMode, applyMode, pause, resume, DEFAULT_CONFIG };
