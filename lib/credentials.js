...
function persist() {
  ...
  try { require("./atomic-write").atomicWriteFileSync(FILE, JSON.stringify(byWallet)); }
...
module.exports = { record, setOwnership, getByWallet, getBySlug, resolve, stats, slugFor, all: () => Object.values(byWallet), isPersistent: () => persistent };
