  ...
  if (saved && saved.days) {
    for (const [d, b] of Object.entries(saved.days)) {
      days[d] = {
        ...
        refs: b.refs || {}, visitors: new Set(b.visitors || []),
      };
    }
  }
}
...
function bucket(d) {
  if (!days[d]) days[d] = { views: 0, paths: {}, tools: {}, refs: {}, visitors: new Set() };
  return days[d];
}
...
function serialize() {
  ...
  for (const [d, b] of Object.entries(days)) {
    out.days[d] = { views: b.views, paths: b.paths, tools: b.tools, refs: b.refs, visitors: [...b.visitors] };
  }
  return out;
}
...
module.exports = { trackView, trackTool, summary, flush };
