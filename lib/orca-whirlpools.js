...
// CLKN/USDC, CLKN/SOL and CLKN/cbBTC; everything else (XPX/FCKN pairs) is hidden by default.
const QUOTE_TOKENS = {
  [USDC_MINT]: "USDC",
  [WSOL_MINT]: "SOL",
  [CBBTC_MINT]: "BTC",
...
const DEFAULT_TOKEN = { mint: CLKN_MINT, symbol: "CLKN", quoteMints: [USDC_MINT, WSOL_MINT, CBBTC_MINT] };
...
module.exports = {
  CLKN_MINT, USDC_MINT, WSOL_MINT, CBBTC_MINT,
  DEFAULT_TOKEN,
  discoverPools,
  getPoolState,
  suggestRanges,
