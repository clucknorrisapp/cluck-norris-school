...
async function poolWalls(poolAddress, tokenMint, spotUsd = null) {
  ...
  return { pool: poolAddress, quoteSymbol: st.quoteSymbol, quoteMint: st.quoteMint, tokenPriceInQuote: st.tokenPriceInQuote, tickCurrentIndex: st.tickCurrentIndex, count: walls.length, walls };
}
