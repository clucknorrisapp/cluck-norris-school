...
// PancakeSwap v3 (Solana) is a Raydium-CLMM fork (identical PoolState layout, disc f7ede3f5…):
...
const READABLE_DEXES = new Set(["meteora", "meteora-damm-v2", "orca", "raydium", "raydium-clmm", "raydium-cpmm", "pancakeswap-v3-solana", "fluxbeam", "saros-amm"]);
...
async function feePctForPool(pool, conn) {
  ...
  else if (dex === "pancakeswap-v3-solana") fee = await raydiumClmmForkFeePct(pool.address, conn);
