...
function get(id) { return store.subs[String(id)] || null; }
...
module.exports = { sanitizeForm, submit, get, list, adminUpdate, clientView, findByWalletMint, STATUSES, SOL_ADDR_RE };
