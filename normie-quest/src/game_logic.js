...
if(typeof document!=='undefined'){ (function(){
  ...
  if(/[?&#]joystick=1(\b|$)/.test((location.search||'')+(location.hash||''))) return;   // ?joystick=1 → the floating-joystick module below owns touch input instead of this gutter D-pad
  var css=document.createElement('style');
...
if(typeof document!=='undefined'){ (function(){
  var isTouch=('ontouchstart' in window)||(navigator.maxTouchPoints>0);
  var on=/[?&#]joystick=1(\b|$)/.test((location.search||'')+(location.hash||''));
