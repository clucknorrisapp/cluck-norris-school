...
var Game=new Phaser.Class({ Extends:Phaser.Scene,
  ...
  makeEnemy:function(kind,x,y,range){
    ...
    var tex = (kind==='sniper'||kind==='sandwich'||kind==='flashbot') ? 'bot' : (kind==='gasgoblin' ? 'troll' : (kind==='drillbit' ? 'drillworm' : kind));   // FLASHBOT reuses the bot sprite; DRILLBIT has its own drill-worm sprite
